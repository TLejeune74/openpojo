...
public class ASMServiceEnd2EndTest {
    ...
    public void implementAbstractToString() {
        ...
        assertNotNull(abstractToString);
    ...
    public void tryOutAbstractMethods() {
        ...
        for (PojoMethod method : pojoClass.getPojoMethods())
            if (!method.isConstructor()) {
                ...
                assertTrue(method.isAbstract(), "Method" + method);
                ...
                if (!returnType.equals(Void.class) && !returnType.equals(void.class))
                    assertNotNull(method.invoke(instance, params), "Method " + method);
                else
                    assertNotNull(method.invoke(instance, params), "Method " + method);
            }
    }
    ...
    public void shouldInvokeUsingConstructorArgs() {
        ...
        assertTrue(pojoClass.isAbstract());
        ...
        assertEquals(12, constructorParameters.size());
        int index = 0;
    ...
    public void shouldDefaultForToStringWithPrams() {
        ...
        assertTrue(randomValue.toString().startsWith(type.getName() + DefaultSubClassDefinition.GENERATED_CLASS_POSTFIX + "@"));
    }
    ...
    public void canGenerateSubClassForPrivateConstructor() {
        ...
        assertNotNull(randomInstance.toString());
    }
